 ...
 * }
 */
export const createPSessionInputValidation = ({ slotId, vehicleId, vehicleNumber, vehicleOwnerPhone, vehicleOwnerAddress, vehicleOwnerNextOfKin, vehicleOwnerNextOfKinPhone, vehicleOwnerNextOfKinAddress }) => {
    const slotIdInput = {
        value: Number(slotId),
        required: true,
        minNumber: 1
    ...
    ;
    const vehicleOwnerAddressInput = {
    ...
    ;
    const vehicleOwnerNextOfKinInput = {
    ...
    ;
    const vehicleOwnerNextOfKinPhoneInput = {
    ...
    ;
    const vehicleOwnerNextOfKinAddressInput = {
